...
__deprecated_msg("Use AxonixFullScreenAdViewController instead. You'll need to import the AxonixFullScreenAdViewController.h header instead of MobclixFullScreenAdViewController.h")
 ...
 */
@property(nonatomic,weak) id<MobclixFullScreenAdDelegate> delegate;
@end
